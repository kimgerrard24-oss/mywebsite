// backend/src/shares/policy/share-external.policy.ts
...
export type ShareExternalDecision =
  | 'OK'
  | 'NOT_FOUND'
  | 'POST_DELETED'
  | 'POST_HIDDEN'
...
export class ShareExternalPolicy {
  static decide(ctx: {
    post: {
      isDeleted: boolean;
      isHidden: boolean;
  ...
  // external share always blocked for CUSTOM
  return 'VISIBILITY_DENIED';
