...
// ==================================================
// FIREBASE INIT (No duplicate app)
// ==================================================
...
function LoginPageInner() {
  ...
  // ==================================================
  // A: Session Check (If logged in → redirect /feed)
  // ==================================================
  useEffect(() => {
    ...
    // No session cookie → stay on login
  ...
  useEffect(() => {
    const run = async () => {
      try {
        ...
        // Login Firebase with customToken
        await signInWithCustomToken(auth, customToken);

        // Try to obtain Firebase user
  ...
  // ==================================================
  // C: Social login buttons (Google/Facebook)
  // ==================================================
  const SITE_ORIGIN =
