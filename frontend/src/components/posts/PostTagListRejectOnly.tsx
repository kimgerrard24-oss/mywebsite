// frontend/src/components/posts/PostTagListRejectOnly.tsx

"use client";

import { useState } from "react";
import type { PostUserTagItem } from "@/types/post-user-tag";
import PostRejectTagButton from "./PostRejectTagButton";
...
export default function PostTagListRejectOnly({
  postId,
  tags,
}: Props) {
